...
const emit = defineEmits(['update:savings', 'update:carLabel']);
...
const isComparing = computed(() => !!props.comparisonBike);
...
const displayedBikeType = computed(() => props.comparisonBike || recommendationType.value);
