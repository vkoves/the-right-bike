export const BIKE_RECOMMENDATIONS = {
  'regular-bike': {
    budget: {
  ...
  'commuter-ebike': {
    ...
    premium: {
      ...
      price: '$4,000',
      image: '/images/bike-models/specialized-turbo-vado.webp',
      review: 'https://road.cc/ebiketips/content/reviews/specialized-turbo-vado-40/'
    }
  },
